```{image} https://img.shields.io/badge/sitcomtn--019-lsst.io-brightgreen.svg
...
This technote is published to <https://sitcomtn-019.lsst.io/> whenever you push changes to the `main` branch on GitHub.
When you push changes to a another branch, a preview of the technote is published to <https://sitcomtn-019.lsst.io/v>.

## Editing this technical note

The main content of this technote is in `index.md` (a MarkDown).
